...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ($pathinfo === '/register-user') {
            return array (  '_controller' => 'Acme\\StoreBundle\\Controller\\RegistrationController::registerAction',  '_route' => 'acme_store_register_user',);
        }
        ...
        if (0 === strpos($pathinfo, '/a')) {
            ...
            if (0 === strpos($pathinfo, '/api/v1')) {
                ...
                if (0 === strpos($pathinfo, '/api/v1/login-user') && preg_match('#^/api/v1/login\\-user(?:\\.(?P<_format>xml|json|html))?$#s', $pathinfo, $matches)) {
