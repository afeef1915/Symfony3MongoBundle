        ...
        if (0 === strpos($pathinfo, '/a')) {
            ...
            if (0 === strpos($pathinfo, '/api')) {
                if (0 === strpos($pathinfo, '/api/v1')) {
                    ...
                    // rest_api_register
                    if (0 === strpos($pathinfo, '/api/v1/create-new-product') && preg_match('#^/api/v1/create\\-new\\-product(?:\\.(?P<_format>xml|json|html))?$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'rest_api_register')), array (  '_controller' => 'Acme\\StoreBundle\\Controller\\RestApiController::createAction',  '_format' => 'json',));
                    }

                }

                // acme_store_login_user
                if (0 === strpos($pathinfo, '/api/login_check') && preg_match('#^/api/login_check(?:\\.(?P<_format>xml|json|html))?$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'acme_store_login_user')), array (  '_controller' => 'Acme\\StoreBundle\\Controller\\LoginController::loginAction',  '_format' => 'json',));
                }

                // acme_store_register_user
                if (0 === strpos($pathinfo, '/api/v1/register-user') && preg_match('#^/api/v1/register\\-user(?:\\.(?P<_format>xml|json|html))?$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'acme_store_register_user')), array (  '_controller' => 'Acme\\StoreBundle\\Controller\\RegistrationController::registerAction',  '_format' => 'json',));
                }
